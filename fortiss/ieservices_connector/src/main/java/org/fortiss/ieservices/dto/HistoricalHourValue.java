...
public class HistoricalHourValue implements Serializable, IeserviceHistorical {
	...
	//Default constructor 
	public HistoricalHourValue() {}

	//Constructor initializing the parameters
	public HistoricalHourValue(int id, int messstellenid, double messwert, long zeitstempel) {
		this.id = id;
	...
	public void setIntegral(double messwert) {
		this.integral = messwert;
	}
	...
	public String toString() {
		return "HistoricalHourValue " + this.id + " Messstelle " + this.messstellenid + " IntegralWert " +  this.integral + " Zeitstempel " + this.zeitstempel;
	}
